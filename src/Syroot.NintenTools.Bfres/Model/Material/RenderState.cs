...
namespace Syroot.NintenTools.Bfres
{
    ...
    public class RenderState : IResData
    {
        ...
        void IResData.Load(ResFileLoader loader)
        {
            ...
            _alphaControl = AlphaControl;
            _blendControl = BlendControl;
            _polygonControl = PolygonControl;
        ...
        {
            AlphaControl = _alphaControl;
            BlendControl = _blendControl;
            PolygonControl = _polygonControl;
            ColorControl = _colorControl;
            DepthControl = _depthControl;
